...
path_objetivo =  BASE_DIR / 'consola' / ''
path_algoritmo =  BASE_DIR / 'consola' / ''
path_entradas_salidas = BASE_DIR / 'consola' / ''
path_metricas =  BASE_DIR / 'consola' / ''
path_modelo_implementado = BASE_DIR / 'consola' / ''
path_train_test = BASE_DIR / 'consola' / ''
path_metricas_calculadas = BASE_DIR / 'consola' / ''
path_resultados = BASE_DIR / 'consola' / ''
